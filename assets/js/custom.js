    ...
    $('.gcitation' ).on( 'click', function() {
        ...
        var option = {
            ...
            series: [{
                name: 'Annual Citation',
                type: 'bar',
                data: [22, 39, 80, 85, 117, 139, 153, 212, 242, 276, 311, 318, 351, 364, 355, 351, 462, 313]
            },
            {
                name: 'Total Citation',
                type: 'line',
                yAxisIndex: 1,
                data: [22, 61, 141, 226, 343, 482, 635, 847, 1089, 1365, 1676, 1994, 2345, 2709, 3064, 3415, 3877, 4190]
            }
        ]
        };
